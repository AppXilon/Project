                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> " enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-4 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="FAQ_Question" placeholder="Type the question" aria-describedby="inputGroupPrepend" name="FAQ_Question" Required>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col-md-4 mb-3">
                                                    <label for="FAQ_Answer">Answer:</label>
                                                    <input type="text" class="form-control" id="FAQ_Answer" placeholder="Type the answer" aria-describedby="inputGroupPrepend" name="FAQ_Answer" Required>
                                                </div>
                                            </div>
                                        ...
                                        echo "<script>alert('Not save something went worng');</script>";
                                        }
                                    }
